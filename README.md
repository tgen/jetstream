...
as a Python package. Both options are described here:
...
- [**Python Modules**](#building-pipelines-from-python-modules): Using the functions and
  classes in the `jetstream` package to manually construct a workflow object from Python
  code.
...
- **Tasks** are the fundamental unit of a workflow. They describe what to do: usually
